...
const LandingPage = () => {
    ...
    const handleAuthOpen = (mode) => { setAuthMode(mode); setShowAuthModal(true); };
    ...
    return (
        <div>
            ...
            <Container className="mt-4">
                <Row>
                    {filteredList
                        .filter(barang => barang.status === 'Available' && (barang.status_periode === "Periode 1" || barang.status_periode === "Periode 2"))
                        .map((barang, index) => (
